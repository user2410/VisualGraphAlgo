...
public class EKStateMaker extends StateMaker{
	...
	public static final ArrayList<Step> steps = new ArrayList<Step>(Arrays.asList(
			...
			new Step("find an augmenting path using BFS", 1, 2),
	...
	public AlgoState makeState3(Algorithm algo, long bottleneck, int u, int v, ArrayList<Edge> path, boolean inc) {
	...
	public AlgoState makeState5(Algorithm algo) {
		return new AlgoState(algo.getRGraph(), currentFlowText(algo), "No more augmenting path.", new Step("", -1, -1));
	}
}
